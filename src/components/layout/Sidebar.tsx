...
export default function Sidebar() {
    const { sidebarCollapsed: collapsed, setSidebarCollapsed: setCollapsed, mobileMenuOpen, setMobileMenuOpen, logout } = useApp();
    ...
    useEffect(() => {
        const updateWidth = () => {
            ...
            document.documentElement.style.setProperty(
                "--sidebar-width",
                isMobile ? "0px" : (collapsed ? "72px" : "220px")
            );
        };
        updateWidth();
    ...
    return (
        <>
            ...
            <aside
                className={`fixed left-0 top-0 h-screen z-50 flex flex-col transition-all duration-300 ease-in-out lg:translate-x-0 ${mobileMenuOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
                style={{
